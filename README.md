...
```sh
pip install git+https://github.com/at146/swagger-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/at146/swagger-client.git`)
...
*TbankPaymentsApi* | [**get_new_tbank_payment_api_v1_tbank_payments_tbank_kasses_tbank_kassa_id_order_id_get**](docs/TbankPaymentsApi.md#get_new_tbank_payment_api_v1_tbank_payments_tbank_kasses_tbank_kassa_id_order_id_get) | **GET** /api/v1/tbank-payments/tbank-kasses/{tbank_kassa_id}/{order_id} | Get New Tbank Payment
...
## Documentation For Models
 ...
 - [InsertBarcode](docs/InsertBarcode.md)
 ...
 - [InsertYookassaPayment](docs/InsertYookassaPayment.md)
 ...
 - [UpdateDeliveryCdek](docs/UpdateDeliveryCdek.md)
 - [UpdateInfoItem](docs/UpdateInfoItem.md)
 - [UpdateInfoItemNew](docs/UpdateInfoItemNew.md)
 - [UpdateOrder](docs/UpdateOrder.md)
 - [UpdatePurchase](docs/UpdatePurchase.md)
 - [UpdateUserBotMess](docs/UpdateUserBotMess.md)
 - [UpdateWaybill](docs/UpdateWaybill.md)
