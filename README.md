...
*TbankKassesApi* | [**get_tbank_kassa_api_v1_tbank_kasses_get**](docs/TbankKassesApi.md#get_tbank_kassa_api_v1_tbank_kasses_get) | **GET** /api/v1/tbank-kasses | Get Tbank Kassa
