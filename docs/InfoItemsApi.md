...
> object insert_or_update_api_v1_info_items_token_post(token, info_item_insert)
...
async with swagger_client.ApiClient(configuration) as api_client:
    ...
    info_item_insert = swagger_client.InfoItemInsert() # InfoItemInsert | 
...
------------- | ------------- | ------------- | -------------
 **token** | **str**|  | 
 **info_item_insert** | [**InfoItemInsert**](InfoItemInsert.md)|  | 
...
> object update_api_v1_info_items_token_put(token, info_item_update)
...
> object update_new_api_v1_info_items_token_new_put(token, info_item_update_new)
