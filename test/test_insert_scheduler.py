...
class TestInsertScheduler(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InsertScheduler:
        """Test InsertScheduler
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertScheduler`
        """
        model = InsertScheduler()
        if include_optional:
