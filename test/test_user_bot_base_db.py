...
class TestUserBotBaseDb(unittest.TestCase):
    """UserBotBaseDb unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserBotBaseDb:
        """Test UserBotBaseDb
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserBotBaseDb`
        """
        model = UserBotBaseDb()
        if include_optional:
            return UserBotBaseDb(
                id = 56,
                user_id = 56,
                bot_token = '',
                last_mess = 56,
