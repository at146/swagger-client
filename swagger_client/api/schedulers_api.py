...
class SchedulersApi:
    ...
    async def delete_api_v1_schedulers_scheduler_id_delete(
        ...
        _param = self._delete_api_v1_schedulers_scheduler_id_delete_serialize(
    ...
    def _delete_api_v1_schedulers_scheduler_id_delete_serialize(
        self,
        scheduler_id,
        _request_auth,
        _content_type,
        ...
        if scheduler_id is not None:
            _path_params['scheduler_id'] = scheduler_id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/schedulers/{scheduler_id}',
    ...
    async def get_api_v1_schedulers_get(
        ...
        _param = self._get_api_v1_schedulers_get_serialize(
            token=token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def get_api_v1_schedulers_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SchedulerBaseDb]]:
        """Get
    ...
    def _get_api_v1_schedulers_get_serialize(
        self,
        token,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/schedulers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def insert_api_v1_schedulers_post(
        ...
        :param insert_scheduler: (required)
        :type insert_scheduler: InsertScheduler
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._insert_api_v1_schedulers_post_serialize(
            insert_scheduler=insert_scheduler,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _insert_api_v1_schedulers_post_serialize(
        self,
        insert_scheduler,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if insert_scheduler is not None:
            _body_params = insert_scheduler
