...
class TbankKassesApi:
    ...
    @validate_call
    async def insert_api_v1_tbank_kasses_post(
        self,
        insert_t_bank_kassa: InsertTBankKassa,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param insert_t_bank_kassa: (required)
        :type insert_t_bank_kassa: InsertTBankKassa
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._insert_api_v1_tbank_kasses_post_serialize(
            insert_t_bank_kassa=insert_t_bank_kassa,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def insert_api_v1_tbank_kasses_post_with_http_info(
        self,
        insert_t_bank_kassa: InsertTBankKassa,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def insert_api_v1_tbank_kasses_post_without_preload_content(
        self,
        insert_t_bank_kassa: InsertTBankKassa,
        _request_timeout: Union[
            None,
    ...
    def _insert_api_v1_tbank_kasses_post_serialize(
        self,
        insert_t_bank_kassa,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if insert_t_bank_kassa is not None:
            _body_params = insert_t_bank_kassa
