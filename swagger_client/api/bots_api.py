...
class BotsApi:
    ...
    @validate_call
    async def get_bot_by_id_api_v1_bots_ids_bot_id_get(
        self,
        bot_id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_bot_by_id_api_v1_bots_ids_bot_id_get_serialize(
            bot_id=bot_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_bot_by_id_api_v1_bots_ids_bot_id_get_with_http_info(
        self,
        bot_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_bot_by_id_api_v1_bots_ids_bot_id_get_without_preload_content(
        self,
        bot_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _get_bot_by_id_api_v1_bots_ids_bot_id_get_serialize(
        self,
        bot_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/bots/ids/{bot_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
