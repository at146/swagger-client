...
class ItemsApi:
    ...
    @validate_call
    async def get_count_models_api_v1_items_category_brand_count_models_get(
        self,
        category: StrictStr,
        brand: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._get_count_models_api_v1_items_category_brand_count_models_get_serialize(
            category=category,
            brand=brand,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_count_models_api_v1_items_category_brand_count_models_get_with_http_info(
        self,
        category: StrictStr,
        brand: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_count_models_api_v1_items_category_brand_count_models_get_without_preload_content(
        self,
        category: StrictStr,
        brand: StrictStr,
        _request_timeout: Union[
    ...
    def _get_count_models_api_v1_items_category_brand_count_models_get_serialize(
        self,
        category,
        brand,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/items/{category}/{brand}/count-models',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
