...
class SchedulerBaseDb(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users_bots": UserBotBase.from_dict(obj["users_bots"]) if obj.get("users_bots") is not None else None,
            "messages_tg": MessageTgBase.from_dict(obj["messages_tg"]) if obj.get("messages_tg") is not None else None
        })
        return _obj
