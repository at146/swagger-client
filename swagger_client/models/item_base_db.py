...
class ItemBaseDb(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.manufacturer_country is None
            and "manufacturer_country" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "quantities": [
                    QuantityBaseDb.from_dict(_item) for _item in obj.get("quantities")
                ]
                if obj.get("quantities") is not None
                else None,
                "category": CategoryBase.from_dict(obj.get("category"))
                if obj.get("category") is not None
                else None,
                "dimension": DimensionBase.from_dict(obj.get("dimension"))
