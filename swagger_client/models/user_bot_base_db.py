...
class UserBotBaseDb(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "user_id", "bot_token", "last_mess", "items", "new_user", "subscribe_channel", "utm_mark_id", "date_added", "is_active", "user", "bot", "partner", "utm_mark", "orders"]
