...
class PurchaseBaseDb(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.delivery_cdek_id is None
            and "delivery_cdek_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.delivery_cdek_photo_tg_file_id is None
            and "delivery_cdek_photo_tg_file_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.yookassa_payment is None
            and "yookassa_payment" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "delivery_cdek_photo_tg_file_id": obj.get(
                    "delivery_cdek_photo_tg_file_id"
                ),
                "item": ItemBase.from_dict(obj.get("item"))
                if obj.get("item") is not None
                else None,
                "order": OrderBase.from_dict(obj.get("order"))
                if obj.get("order") is not None
                else None,
                "delivery_cdek": DeliveryCdekBase.from_dict(obj.get("delivery_cdek"))
                if obj.get("delivery_cdek") is not None
                else None,
                "size": SizeBase.from_dict(obj.get("size"))
                if obj.get("size") is not None
                else None,
                "yookassa_payment": YookassaPaymentBase.from_dict(
                    obj.get("yookassa_payment")
                )
                if obj.get("yookassa_payment") is not None
                else None,
            }
        )
        return _obj
